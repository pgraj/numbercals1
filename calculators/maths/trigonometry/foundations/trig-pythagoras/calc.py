"""Pythagoras' theorem calculator — Foundations cluster of the Trigonometry topic.
...
Stage 1 also uses this calculator to PROVE the shared NCLearn engine: its
animation shows the two small squares (a^2, b^2) visibly summing to the big
square (c^2).
"""
import math
...
@register(
    ...
    tags=[
        ...
        "trigonometry", "CBSE Class 8", "GCSE", "KS3", "Common Core Grade 8",
        "Singapore Sec 2", "France 4e", "Germany Klasse 9", "ACARA Year 9",
        "NSW Stage 5", "UAE Grade 8",
    ],
    viz_template="viz/trig-pythagoras.html",
    scholar=None,
)
