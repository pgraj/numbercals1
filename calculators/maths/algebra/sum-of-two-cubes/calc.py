"""Sum of Two Cubes a³+b³ — maths › Algebra › Sum / Difference of Two Cubes. Factor and verify a³+b³ = (a+b)(a²−ab+b²), with each factor shown numerically."""
from core.registry import register


@register(
    slug='sum-of-two-cubes', name='Sum of Two Cubes a³+b³', section="maths", topic="Algebra", sub='Sum / Difference of Two Cubes',
    tags=['algebra', 'identity', 'factorisation', 'sum of two cubes'],
    formula='a³ + b³ = (a+b)(a² - ab + b²)',
    summary='Factor and verify a³+b³ = (a+b)(a²−ab+b²), with each factor shown numerically.',
    viz_template="viz/sum-of-two-cubes.html",
...
def compute(a=3, b=2):
    ...
    return {"result": result, "identity": uni_identity, "lhs_label": uni_lhs,
            ...
            "expand_title": 'Sum of Two Cubes a³+b³',
