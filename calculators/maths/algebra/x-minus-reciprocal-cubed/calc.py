...
@register(
    slug='x-minus-reciprocal-cubed', name='If x − 1/x = a, then x³ − 1/x³ = a³ + 3a', section="maths", topic="Algebra", sub='Substitution Identities',
    tags=['algebra', 'identity', 'x minus reciprocal cubed'],
    formula='x - 1/x = a  =>  x³ - 1/x³ = a³ + 3a',
    summary='Verify: if x − 1/x = a then x³ − 1/x³ = a³ + 3a, using your value of x.',
    viz_template="viz/x-minus-reciprocal-cubed.html",
    scholar="diophantus",
)
def compute(x=2):
