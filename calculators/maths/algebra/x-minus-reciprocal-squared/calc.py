...
@register(
    slug='x-minus-reciprocal-squared', name='If x − 1/x = a, then x² + 1/x² = a² + 2', section="maths", topic="Algebra", sub='Substitution Identities',
    tags=['algebra', 'identity', 'x minus reciprocal squared'],
    formula='x - 1/x = a  =>  x² + 1/x² = a² + 2',
    summary='Verify: if x − 1/x = a then x² + 1/x² = a² + 2, using your value of x.',
    viz_template="viz/x-minus-reciprocal-squared.html",
    scholar="diophantus",
)
def compute(x=3):
