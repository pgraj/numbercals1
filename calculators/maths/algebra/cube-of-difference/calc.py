"""Cube of a Difference (a−b)³ — maths › Algebra › Cube Identities. Expand and verify (a−b)³ = a³ − 3a²b + 3ab² − b³, each term shown numerically."""
from core.registry import register


@register(
    slug='cube-of-difference', name='Cube of a Difference (a−b)³', section="maths", topic="Algebra", sub='Cube Identities',
    tags=['algebra', 'identity', 'expansion', 'cube', 'cube of difference'],
    formula='(a-b)³ = a³ - 3a² b + 3ab² - b³',
    summary='Expand and verify (a−b)³ = a³ − 3a²b + 3ab² − b³, each term shown numerically.',
    viz_template="viz/cube-of-difference.html",
    scholar="pingala",
)
def compute(a=5, b=2):
    ...
    return {"result": result, "identity": uni_identity,
            ...
            "verified": verified, "expand_title": "Cube of a Difference (a−b)³ expansion",
