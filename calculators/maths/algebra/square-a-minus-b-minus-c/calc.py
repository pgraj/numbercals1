"""Square of (a−b−c) — maths › Algebra › Square Identities. Expand and verify (a−b−c)² with correct signs on each cross term, shown numerically."""
from core.registry import register


@register(
    slug='square-a-minus-b-minus-c', name='Square of (a−b−c)', section="maths", topic="Algebra", sub='Square Identities',
    tags=['algebra', 'identity', 'expansion', 'square', 'square a minus b minus c'],
    formula='(a-b-c)² = a²+b²+c²-2ab-2ca+2bc',
    summary='Expand and verify (a−b−c)² with correct signs on each cross term, shown numerically.',
    viz_template="viz/square-a-minus-b-minus-c.html",
    scholar="al-khwarizmi",
)
def compute(a=9, b=2, c=3):
    uni_identity = '(a-b-c)² = a² + b² + c² - 2ab - 2ca + 2bc'
    uni_lhs = '(a-b-c)²'
    try:
    ...
    lhs = (a - b - c) ** 2
    terms = [{"tex": r"a^2", "num": a*a}, {"tex": r"b^2", "num": b*b}, {"tex": r"c^2", "num": c*c}, {"tex": r"-2ab", "num": -2*a*b}, {"tex": r"-2ca", "num": -2*c*a}, {"tex": r"2bc", "num": 2*b*c}]
    ...
    steps = [
        {"label": "The identity",
         "math": r"\( (a-b-c)^2 = a^2 + b^2 + c^2 - 2ab - 2ca + 2bc \)"},
