"""Square of a Difference (a−b)² — maths › Algebra › Square Identities. Expand and verify (a−b)² = a² − 2ab + b², with each term shown numerically."""
from core.registry import register


@register(
    slug='square-of-difference', name='Square of a Difference (a−b)²', section="maths", topic="Algebra", sub='Square Identities',
    tags=['algebra', 'identity', 'expansion', 'square', 'square of difference'],
    formula='(a-b)² = a² - 2ab + b²',
    summary='Expand and verify (a−b)² = a² − 2ab + b², with each term shown numerically.',
    viz_template="viz/square-of-difference.html",
...
def compute(a=7, b=2):
    ...
    return {"result": result, "identity": uni_identity,
            ...
            "verified": verified, "expand_title": "Square of a Difference (a−b)² expansion",
