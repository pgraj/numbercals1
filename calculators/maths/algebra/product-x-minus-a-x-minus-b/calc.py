...
@register(
    slug='product-x-minus-a-x-minus-b', name='(x−a)(x−b)', section="maths", topic="Algebra", sub='Other Useful Identities',
    tags=['algebra', 'identity', 'expansion', 'product', 'product x minus a x minus b'],
    formula='(x-a)(x-b) = x² - (a+b)x + ab',
    summary='Expand and verify (x−a)(x−b) = x² − (a+b)x + ab.',
    viz_template="viz/product-x-minus-a-x-minus-b.html",
    scholar="francois-viete",
)
def compute(x=7, a=2, b=3):
