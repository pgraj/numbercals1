"""Square of (a+b−c) — maths › Algebra › Square Identities. Expand and verify (a+b−c)² with mixed cross-term signs, shown numerically."""
from core.registry import register


@register(
    slug='square-a-plus-b-minus-c', name='Square of (a+b−c)', section="maths", topic="Algebra", sub='Square Identities',
    tags=['algebra', 'identity', 'expansion', 'square', 'square a plus b minus c'],
    formula='(a+b-c)² = a²+b²+c²+2ab-2bc-2ca',
    summary='Expand and verify (a+b−c)² with mixed cross-term signs, shown numerically.',
    viz_template="viz/square-a-plus-b-minus-c.html",
    scholar="al-khwarizmi",
)
def compute(a=5, b=4, c=3):
