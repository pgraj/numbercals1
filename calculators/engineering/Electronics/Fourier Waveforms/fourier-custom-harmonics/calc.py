"""Custom Harmonics — Additive Synthesis — Engineering > Electronics > Fourier Waveforms.
...
@register(
    ...
    name="Custom Harmonics — Additive Synthesis",
    section="engineering",
    topic="Electronics",
    sub="Fourier Waveforms",
    tags=["fourier", "additive synthesis", "harmonics", "audio"],
    formula="y(t)=sum_i A_isin(n_iomega t+varphi_i)",
    summary="Add and remove arbitrary harmonics to build a tone from scratch — the additive synthesis behind pipe and drawbar organs.",
