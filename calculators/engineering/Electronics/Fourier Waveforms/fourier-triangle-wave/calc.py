"""Triangle Wave Fourier Series â€” Engineering > Electronics > Fourier Waveforms.
...
@register(
    ...
    summary="See why a triangle wave converges so fast â€” its harmonics fall off as 1/n squared.",
