"""Diffraction Patterns (Aperture â†’ Light) â€” Engineering > Electronics > Applications of Fourier.
...
@register(
    slug="fourier-diffraction",
    scholar="joseph-fourier",
    name="Diffraction Patterns (Aperture â†’ Light)",
    section="engineering",
    topic="Electronics",
    sub="Applications of Fourier",
    tags=["fourier", "diffraction", "optics", "fft", "interference"],
    formula="I(theta) propto big|mathcal{F}{text{aperture}}big|^{2}",
    summary="The far-field light intensity through slits is the squared magnitude of the aperture's Fourier transform.",
    viz_template="viz/fourier-diffraction.html",
)
def compute():
