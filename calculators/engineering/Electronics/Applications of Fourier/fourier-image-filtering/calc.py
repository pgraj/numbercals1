"""Image Filtering (1D Pixel Row) â€” Engineering > Electronics > Applications of Fourier.
...
@register(
    ...
    summary="Low-pass blurs and high-pass finds edges â€” the frequency-domain view of everyday image processing.",
